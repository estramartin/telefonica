        ...
        <>
            ...
            <div className="row justify-content-center mb-5">
                <div className=" col-10">
                    <div className="bg bg-secondary link-light p-4 border border-dark border-3">
                    ...
                    <div className="row justify-content-center">
                        {
                            ...
                            cliente.map((datos, index) => {
                                ...
                                return (
                                    ...
                                    <div key={index} className=" bg bg-secondary border border-dark border-3 m-5 col-5 ">

                                        <h3 className="link-light">Equipo</h3>
                                        ...
                                        <h3 className="link-light">Linea Asociada</h3>
                                        <div className="bg-light">
